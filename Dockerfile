...
RUN rm -rf package-lock.json && yarn add ts-proto @grpc/grpc-js swagger-themes class-transform class-transformer class-validator paytabs_pt2 moment ioredis express-prettier express-slow-down redis-url rate-limit-redis better-sqlite3
